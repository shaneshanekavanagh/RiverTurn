...
public class AmbColour : MonoBehaviour {	
	...
	void Start()
    {
		...
		RenderSettings.ambientLight = color0;
	}
    ...
    {			
        ...
        {				
			...
			RenderSettings.ambientLight = Color.Lerp(color0, color1, timer1);
				
			if(RenderSettings.ambientLight == color1)
            {
				change1 = true;
				startBool = false;
			}
        ...
        {				
			...
			RenderSettings.ambientLight = Color.Lerp(color1, color2, timer2);
			
			if(RenderSettings.ambientLight == color2){
				change2 = true;
				change1 = false;
			}
		}
        ...
        {				
			...
			RenderSettings.ambientLight = Color.Lerp(color2, color3, timer3);
			
            if(RenderSettings.ambientLight == color3)
            {
				change3 = true;
				change2 = false;
			}
        ...
        {				
			...
			RenderSettings.ambientLight = Color.Lerp(color3, color4, timer4);
				
			if(RenderSettings.ambientLight == color4)
            {
				change4 = true;
				change3 = false;
			}
